...
namespace KnxTest.Integration
{
    ...
    public class VeryOldDimmerIntegrationTests : IDisposable
    {
        ...
        private static readonly IDimmerOld _defaulDimmer = new DimmerOld("L11", "Test Light 11", "1", _knxServiceMock);
        private IDimmerOld _dimmer = _defaulDimmer;

        public VeryOldDimmerIntegrationTests(KnxServiceFixture fixture)
        {
            _knxService = fixture.KnxService;
            _dimmer1 = new DimmerOld("DIM1", "Test Dimmer 1", "1", _knxService);
            _dimmer2 = new DimmerOld("DIM2", "Test Dimmer 2", "2", _knxService);
        }

        private readonly DimmerOld _dimmer1;
        private readonly DimmerOld _dimmer2;
